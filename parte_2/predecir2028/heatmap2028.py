...
# Ruta al archivo CSV
csv_path = r"C:\Users\clara\Documentos\3º GED\predicciones\municipios_priorizados_2028.csv"
...
for _, row in df.iterrows():
    ...
    Renta: {row['renta_2028'] if pd.notnull(row['renta_2028']) else 'N/D'}<br>
    Población: {int(row['Poblacion_2028']) if pd.notnull(row['Poblacion_2028']) else 'N/D'}
    """
    folium.CircleMarker(
...
# Guardar mapa
mapa.save("mapa_interactivo_municipios_2028.html")
print("Mapa guardado como mapa_interactivo_municipios_2028.html")
